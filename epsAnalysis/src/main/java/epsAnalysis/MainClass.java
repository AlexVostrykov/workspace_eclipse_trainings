...
public class MainClass {
    ...
    */
    private static List<CompanyAnnualData> getTestDataByTicker(String ticker){ 
...
//		 res.add(y2004);
    ...
    private static List<CompanyAnnualData> getTestDataForTeslaMotorsInc(){
         ...
         CompanyAnnualData y2014 = new CompanyAnnualData(2014, -1.64, ticker);
         res.add(y2014);
	 
         CompanyAnnualData y2013 = new CompanyAnnualData(2013, -0.62, ticker);
         res.add(y2013);
	 
         CompanyAnnualData y2012 = new CompanyAnnualData(2012, -3.69, ticker);
         res.add(y2012);
	 
         CompanyAnnualData y2011 = new CompanyAnnualData(2011, -2.53, ticker);
         res.add(y2011);
	 
         CompanyAnnualData y2010 = new CompanyAnnualData(2010, -3.04, ticker);
         res.add(y2010);
	 
         CompanyAnnualData y2009 = new CompanyAnnualData(2009, -0.70, ticker);
         res.add(y2009);
     ...
     * AYA, HEINY, ALL, MCY, PGR
    */
    private static final String TICKER = "PSEC";
	
	public static void main(String[] args) {
		System.out.println("Analyzing: " + TICKER);
		
		EpsAnalyzer analyzer = new EpsAnalyzer();
		EpsAnalysisResult r = analyzer.analyze(getTestDataByTicker(TICKER));
		if(r != null){
